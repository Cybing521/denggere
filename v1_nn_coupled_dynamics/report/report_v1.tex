...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../results/figures/phase1_coupled_model.png}
    \caption{Phase 1: 神经网络耦合动力学模型结果。
    包含BI拟合、病例拟合（线性和对数尺度）、NN学到的产卵率、
    蚊虫种群动态、NN热力图、年度对比、训练损失等。}
    \label{fig:phase1}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{../results/figures/phase2_formula_discovery.png}
    \caption{Phase 2: 符号回归结果。
    包含候选公式对比、温度/降水响应曲线、NN vs 公式对比、残差分布等。}
    \label{fig:phase2}
\end{figure}
